...
const DEFS := [
	{
		id = NOVEL, key = "type_novel", site = "CentralNovel",
		script = "centralnovel_dlv7.py", volumes = true, lang_flag = "",
	},
	{
		id = MANGALIVRE, key = "type_manga", site = "MangaLivre",
		script = "mangalivre_dlv4.py", volumes = false, lang_flag = "",
	},
	{
		id = MANGAFIRE, key = "type_manga", site = "MangaFire",
		script = "aio_dl_wrapper.py", volumes = false, lang_flag = "--language",
		aio = true,
	},
	{
		id = MANGADEX, key = "type_manga", site = "MangaDex",
